...
class ChatCognee(BaseChatModel):
    ...
    """Cognee chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-cognee`` and set environment variable ``COGNEE_API_KEY``.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Cognee API key. If not passed in will be read from env var COGNEE_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatCognee.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatCognee.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatCognee supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCognee supports async generation. Otherwise delete.
